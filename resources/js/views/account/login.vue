...
export default {
    ...
    methods: {
        async login() {
            ...
            try {
                const response = await axios.post('/api/login/admin', this.auth);
                      ...
                      <img :src="logo" alt height="34"/>
                            ...
                            <BForm action="javascript:void(0)" class="p-2" method="POST">
                                ...
                                <BFormGroup id="input-group-1" class="mb-3" label="Username" label-for="input-1">
                                    <BFormInput id="input-1" v-model="auth.username" name="username" placeholder="Enter Username"
                                                type="text"></BFormInput>
                                </BFormGroup>

                                <BFormGroup id="input-group-2" class="mb-3" label="Password" label-for="input-2">
                                    <BFormInput id="input-2" v-model="auth.password" name="password" placeholder="Enter password"
